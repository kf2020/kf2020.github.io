...
#Boxplots of (1) gradruation rate & (2) admission rate by selectivity 
library(ggplot2)
...
##Fitting model for Median Starting Salary
...
This dataset can be continued to be analyzed to determine many different important factors regarding college education, such as how figuring out which factors determine a university's acceptance rate. Readers could follow the steps provided for performing tests to answer questions of their own.
